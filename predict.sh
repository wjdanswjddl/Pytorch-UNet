...
model=checkpoints/CP50-450.pth
...
# model=model/uresnet-512-l23-cosmic500-e50/CP30-450.pth
...
python predict.py -m ${model} --viz --no-save --no-crf --input ${test} --range 1 2 --mask-threshold 0.7